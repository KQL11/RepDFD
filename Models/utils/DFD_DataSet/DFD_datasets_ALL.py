    ...
    def __init__(self, root_path="", video_names=[], phase='train', test_frame_nums=5, vid_sample=1, is_pillow=True,
        ...
        if phase != 'train':
            ...
            for name in image_name:
                # new_name = name.replace('/home/linkaiqing/code/Reprogramming/dataset',
                #                         '/home/linkaiqing/code/Reprogramming/dataset/Face_Embedding/Transface')
                new_name = name.replace('/home/linkaiqing/code/Reprogramming/dataset/', '/home/linkaiqing/code/Reprogramming/dataset/Face_Embedding/Transface/')
    ...
    def __getitem__(self, index):
        if self.phase == 'train':
            ...
            if self.is_pillow:
                ...
                #     image = t(image)
                #
                #     image.save('/home/linkaiqing/code/Reprogramming/dataset/code/Reprogramming/VP_Deepfake/x.png')
            ...
            # Face Embed Load
            face_emb = torch.load(os.path.join(video_path.replace('/home/linkaiqing/code/Reprogramming/dataset',
                                                                  '/home/linkaiqing/code/Reprogramming/dataset/Face_Embedding/Transface'),
            ...
            # Face Embed Load
            face_emb = torch.load(((image_path.replace('/home/linkaiqing/code/Reprogramming/dataset',
                                                       '/home/linkaiqing/code/Reprogramming/dataset/Face_Embedding/Transface').replace(
...
class CDFDataset(Dataset):
    def __init__(self, root_path="", video_names=[], phase='train', test_frame_nums=10, vid_sample=1, is_pillow=True,
        ...
        if phase != 'train':
            ...
            self.image_name = []
            for name in image_name:
                new_name = name.replace('/home/linkaiqing/code/Reprogramming/dataset/Celeb_DF',
                                        '/home/linkaiqing/code/Reprogramming/dataset/Face_Embedding/Transface/Celeb_DF')
                if os.path.exists(new_name.replace('.png', '.pt')):
                    self.image_name.append(name)
        else:
    ...
    def __getitem__(self, index):
        if self.phase == 'train':
            ...
            # Face Embed Load
            face_emb = torch.load(os.path.join(video_path.replace('/home/linkaiqing/code/Reprogramming/dataset/Celeb_DF',
                                                                  '/home/linkaiqing/code/Reprogramming/dataset/Face_Embedding/Transface/Celeb_DF'),
                                               image_name.replace('.png', '.pt')), map_location='cpu')
            return image, label, face_emb
            ...
            # Face Embed Load
            face_emb = torch.load(((image_path.replace('/home/linkaiqing/code/Reprogramming/dataset/Celeb_DF',
                                                       '/home/linkaiqing/code/Reprogramming/dataset/Face_Embedding/Transface/Celeb_DF').replace(
                '.png', '.pt'))), map_location='cpu')
            return image, label, face_emb
